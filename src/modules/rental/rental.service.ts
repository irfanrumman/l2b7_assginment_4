...
import { CreateRentalRequestValidation, RentalRequestAllGetValidation } from "./rental.validation";
...
const getSingleRentalRequestFromDB = async (rentalId: string, tenantId: string) => {
